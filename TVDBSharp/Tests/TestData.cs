...
namespace Tests {
    ...
    public class TestData {
        private Dictionary<Conversion, Conversion> _showData = new Dictionary<Conversion, Conversion>();
        private List<Dictionary<Conversion, Conversion>> _episodeData = new List<Dictionary<Conversion, Conversion>>();
        ...
        private void AddShowData() {
            ...
            _showData.Add(new Conversion("Airs_Time", "AirTime"), new Conversion("9:00 PM", new TimeSpan(21, 0, 0).ToString()));
            _showData.Add(new Conversion("ContentRating", "ContentRating"), new Conversion("TV-14", ContentRating.TV14.ToString()));
            _showData.Add(new Conversion("FirstAired", "FirstAired"), new Conversion("2001-11-06", new DateTime(2001, 11, 06).ToString()));
            _showData.Add(new Conversion("Genre", "Genres"), new Conversion("|Action|Adventure|Drama|", new List<String>(new[] { "Action", "Adventure", "Drama" }).ToString()));
            _showData.Add(new Conversion("Network", "Network"), new Conversion("FOX", "FOX"));
            _showData.Add(new Conversion("Overview", "Description"), new Conversion("24 is a TV thriller presented in real time.", "24 is a TV thriller presented in real time."));
            ...
            _showData.Add(new Conversion("banner", "Banner"), new Conversion("graphical/76290-g14.jpg", "graphical/76290-g14.jpg"));
            _showData.Add(new Conversion("fanart", "Fanart"), new Conversion("fanart/original/76290-23.jpg", "fanart/original/76290-23.jpg"));
            _showData.Add(new Conversion("lastupdated", "LastUpdated"), new Conversion("1378608881", "1378608881"));
            _showData.Add(new Conversion("poster", "Poster"), new Conversion("posters/76290-4.jpg", "posters/76290-4.jpg"));
        ...
        private void AddEpisodeData() {
            ...
            newEpisode.Add(new Conversion("EpisodeName", "Title"), new Conversion("3:00 A.M.-4:00 A.M.", "3:00 A.M.-4:00 A.M."));
            newEpisode.Add(new Conversion("EpisodeNumber", "EpisodeNumber"), new Conversion("4", "4"));
            newEpisode.Add(new Conversion("FirstAired", "FirstAired"), new Conversion("2001-11-27", new DateTime(2001, 11, 27).ToString()));
            newEpisode.Add(new Conversion("GuestStars", "GuestStars"), new Conversion("|Johnny Vasquez| Mike Siegal| Kathy Byron|", new List<String>(new[] { "Johnny Vasquez", "Mike Siegal", "Kathy Byron" }).ToString()));
            ...
            newEpisode.Add(new Conversion("Overview", "Description"), new Conversion("With Tony in custody, Jack leads his interrogation", "With Tony in custody, Jack leads his interrogation"));
            ...
            newEpisode.Add(new Conversion("Writer", "Writers"), new Conversion("Manny Coto | Brannon Braga", new List<string>(new[] { "Manny Coto", "Brannon Braga" }).ToString()));
            newEpisode.Add(new Conversion("filename", "FileName"), new Conversion("episodes/76290/409267.jpg", "episodes/76290/409267.jpg"));
            ...
            newEpisode.Add(new Conversion("Director", "Director"), new Conversion("Nelson McCormick", "Nelson McCormick"));
            newEpisode.Add(new Conversion("EpisodeName", "Title"), new Conversion("Day 8: 3:00 A.M. - 4:00 A.M.", "Day 8: 3:00 A.M. - 4:00 A.M."));
            newEpisode.Add(new Conversion("EpisodeNumber", "EpisodeNumber"), new Conversion("12", "12"));
            newEpisode.Add(new Conversion("FirstAired", "FirstAired"), new Conversion("2010-03-14", new DateTime(2010, 03, 14).ToString()));
            newEpisode.Add(new Conversion("GuestStars", "GuestStars"), new Conversion("|Kiefer Sutherland|Annie Wersching|Mary Lynn Rajskub|", new List<String>(new[] { "Kiefer Sutherland", "Annie Wersching", "Mary Lynn Rajskub" }).ToString()));
            newEpisode.Add(new Conversion("IMDB_ID", "ImdbID"), new Conversion("tt1463812", "tt1463812"));
            newEpisode.Add(new Conversion("Language", "Language"), new Conversion("en", "en"));
            newEpisode.Add(new Conversion("Overview", "Description"), new Conversion("While Jack and Cole team up in the field to shield New York from the calamitous threat", "While Jack and Cole team up in the field to shield New York from the calamitous threat"));
            ...
            newEpisode.Add(new Conversion("Writer", "Writers"), new Conversion("Chip Johannessen|Patrick Harbinson", new List<string>(new[] { "Chip Johannessen", "Patrick Harbinson" }).ToString()));
            newEpisode.Add(new Conversion("filename", "FileName"), new Conversion("episodes/76290/1482791.jpg", "episodes/76290/1482791.jpg"));
